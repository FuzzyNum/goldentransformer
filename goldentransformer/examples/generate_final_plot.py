...
def generate_final_plot():
    ...
    plt.errorbar(layers, mean_baseline, yerr=std_baseline, label='Baseline Accuracy', fmt='-o', capsize=5)
    plt.errorbar(layers, mean_faulted, yerr=std_faulted, label='Faulted Accuracy', fmt='-s', capsize=5)
